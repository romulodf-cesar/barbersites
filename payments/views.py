            ...
            if usuario_form_validation.is_valid() and barbearia_form_validation.is_valid():
                ...
                try:
                    ...
                    usuario = Usuario.objects.create(
                        email=usuario_cleaned_data['email'],
                ...
                # --- FIM DA LÓGICA CORRIGIDA PARA USUÁRIO ---

                # Lógica para Barbearia (mantida, pois está correta)
